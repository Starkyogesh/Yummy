...
import { View, Text, StyleSheet, SafeAreaView, TouchableOpacity, Image, ScrollView, TextInput, Modal, Alert, FlatList } from 'react-native';


const dosa = { uri: "https://www.shutterstock.com/image-photo/paper-masala-dosa-south-indian-600nw-1008144772.jpg" };
const chapati = { uri: "https://media.istockphoto.com/id/545997902/photo/paneer-butter-masala-with-chapati-roti-paratha.jpg?s=612x612&w=0&k=20&c=YNgrXxxy0VymI43ov0qexXyXReUvD_GEsAP3tep5Vso=" };
const idly = { uri: "https://t3.ftcdn.net/jpg/03/62/02/26/360_F_362022640_fZ6UM0JycJlFDdBiR1pYlNddKfdGvYwR.jpg" };
const parotta = { uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTmMOaQHBniu1JosnT5LOkv_p1hEcbwo4-SgulJlwguFQ&s" };
const poori = { uri: "https://www.awesomecuisine.com/wp-content/uploads/2020/03/poori-masala-kizhangu.jpg" };
...
const VegAndNonVeg = ({ navigation }) => {

    const [food, setFood] = useState([
        { "id": 1, "Name": "Dosa", "Price": 20, quantity: 1 },
        { "id": 3, "Name": "Idly", "Price": 15, quantity: 1 },
        { "id": 5, "Name": "Parotta", "Price": 30, quantity: 1 },
        { "id": 7, "Name": "Poori", "Price": 30, quantity: 1 },
        { "id": 9, "Name": "Chapati", "Price": 30, quantity: 1 },
        { "id": 2, "Name": "Chicken Rice", "Price": 100, quantity: 1 },
        { "id": 4, "Name": "Chicken Noodles", "Price": 100, quantity: 1 },
        { "id": 6, "Name": "Chicken Shawarma", "Price": 80, quantity: 1 },
        { "id": 8, "Name": "Chicken Biryani", "Price": 120, quantity: 1 },
        { "id": 10, "Name": "Roast Chicken", "Price": 150, quantity: 1 }
    ]);
    ...
    const getImage = (id) => {
        if (id == 1) return dosa;
        if (id == 3) return idly;
        if (id == 5) return parotta;
        if (id == 7) return poori;
        if (id == 9) return chapati;
        if (id == 2) return rice;
        if (id == 4) return noodles;
        if (id == 6) return shawarma;
        if (id == 8) return briyani;
        if (id == 10) return roast;
    };
