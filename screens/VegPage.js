...
const Veg = ({ navigation }) => {
    ...
    const [food, setFood] = useState([
        ...
        { "id": 2, "Name": "Idly", "Price": 15, quantity: 1 },
        { "id": 3, "Name": "Parotta", "Price": 30, quantity: 1 },
        { "id": 4, "Name": "Poori", "Price": 30, quantity: 1 },
        { "id": 5, "Name": "Chapati", "Price": 30, quantity: 1 }
    ]);
    ...
    const getImage = (id) => {
        if (id == 1) return dosa;
        if (id == 2) return idly;
        if (id == 3) return parotta;
        if (id == 4) return poori;
        if (id == 5) return chapati;
    };
